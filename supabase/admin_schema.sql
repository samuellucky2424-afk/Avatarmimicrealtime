...
CREATE POLICY "Users read active notifications" ON public.notifications
...
CREATE POLICY "Public reads app settings" ON public.app_settings FOR SELECT USING (TRUE);
