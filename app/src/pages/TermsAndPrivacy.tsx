...
const sections = [
  ...
  ['5. Streaming time and purchases', 'Some features require purchased streaming time. The price and available duration are shown before purchase. Unless applicable law requires otherwise, purchased streaming time is non-refundable and may be subject to the validity period displayed at purchase. Access may be limited when payment is incomplete or these terms are breached.'],
